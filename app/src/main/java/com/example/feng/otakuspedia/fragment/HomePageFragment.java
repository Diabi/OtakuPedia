...
public class HomePageFragment extends Fragment {
    ...
    private void createList() {
        homeAdapter = new HomeAdapter(R.layout.otaku_item, mList, getContext());
        GridLayoutManager manager = new GridLayoutManager(getContext(), 2);
        mRecyclerView.setLayoutManager(manager);
        mRecyclerView.setAdapter(homeAdapter);
        homeAdapter.openLoadAnimation(BaseQuickAdapter.SLIDEIN_LEFT); // 开启动画
        setOnPullLoadMore();
    ...
    private void showOtakuItemInfo(int pos) {
        OtakuItem item = homeAdapter.getItem(pos);
